...
type Tx = {
   ...
   * using {@link useI18n}.
   */
  (i18nInstance: Composer, key: string, named?: Record<string, unknown>): string
}

export const tx: Tx = (arg1: string | Composer, arg2?: Record<string, unknown> | string, arg3?: Record<string, unknown>) => {
  let i18n: Composer
  let key: string
